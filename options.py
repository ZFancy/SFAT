...
def args_parser():
    ...
    parser.add_argument('--out-dir',type=str,default='../Alpha_WFAT_result',help='dir of output')
    parser.add_argument('--agg-opt',type=str,default='FedAvg',help='option of on-device learning: FedAvg, FedProx, Scaffold')
    parser.add_argument('--agg-center',type=str,default='FedAvg',help='option of aggregation: FedAvg, Alpha_WFAT')
